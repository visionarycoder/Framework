...
public static class CliInputUtilities
{
    ...
    private const string FilePromptMessage = "Please enter the path to your file (or type 'exit' to quit):";
    private const string FileEmptyErrorMessage = "File path cannot be empty.";
    private const string FileNotExistErrorMessage = "File does not exist.";
    private const string FolderPromptMessage = "Please enter the path to folder (or x|q|exit to return to the previous menu):";
    private const string FolderEmptyErrorMessage = "Input Error: Input cannot be empty.";
    private const string FolderNotExistErrorMessage = "Folder does not exist.";
