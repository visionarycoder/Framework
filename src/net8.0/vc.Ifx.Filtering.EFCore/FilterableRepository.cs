...
using QueryableExtensions = vc.Ifx.Filtering.QueryableExtensions;

// ReSharper disable MethodSupportsCancellation

namespace vc.Ifx.Data.Filtering.EFCore;

public class FilterableRepository<TDbContext>(ILogger logger, TDbContext ctx) where TDbContext 
    : DbContext
{
