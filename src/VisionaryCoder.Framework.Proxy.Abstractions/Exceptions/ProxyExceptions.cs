...
public class RetryException : ProxyException
{
    ...
    public RetryException(int attemptCount) : base($"Operation failed after {attemptCount} retry attempts")
    {
    ...
    /// <param name="message">The message that describes the error.</param>
    /// <param name="attemptCount">The number of retry attempts made.</param>
    public RetryException(string message, int attemptCount) : base(message)
    {
        AttemptCount = attemptCount;
    }
    ...
    /// <param name="attemptCount">The number of retry attempts made.</param>
    /// <param name="innerException">The exception that is the cause of the current exception.</param>
    public RetryException(string message, int attemptCount, Exception innerException) : base(message, innerException)
    {
        AttemptCount = attemptCount;
    }
}