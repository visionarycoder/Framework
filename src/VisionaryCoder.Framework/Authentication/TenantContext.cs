...
public class TenantContext
{
    ...
    public int? GetResourceLimit(string resourceName) => 
        ResourceLimits.TryGetValue(resourceName, out var limit) ? limit : null;
    ...
    public T? GetSetting<T>(string settingName) => 
        Settings.TryGetValue(settingName, out var value) && value is T typedValue ? typedValue : default;
}