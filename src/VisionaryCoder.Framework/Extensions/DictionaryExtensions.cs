...
public static class DictionaryExtensions
{
    ...
    public static ReadOnlyDictionary<TKey, TValue> ToReadOnlyDictionary<TKey, TValue>(this IDictionary<TKey, TValue> dictionary) where TKey : notnull
    {
    ...
    public static Dictionary<TKey, TValue> Merge<TKey, TValue>(this IDictionary<TKey, TValue> first, IDictionary<TKey, TValue> second, Func<TKey, TValue, TValue, TValue>? conflictResolver = null) where TKey : notnull
    {
    ...
    public static Dictionary<TKey, TResult> TransformValues<TKey, TValue, TResult>(this IDictionary<TKey, TValue> dictionary, Func<TValue, TResult> valueSelector) where TKey : notnull
    {
    ...
    public static Dictionary<TKey, TValue> Where<TKey, TValue>(this IDictionary<TKey, TValue> dictionary, Func<TKey, TValue, bool> predicate) where TKey : notnull
    {
