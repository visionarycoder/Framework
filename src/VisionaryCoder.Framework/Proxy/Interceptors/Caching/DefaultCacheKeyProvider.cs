...
public class DefaultCacheKeyProvider : ICacheKeyProvider
{
    ...
    /// <summary>
    /// Generates a cache key based on the operation name, URL, and method with generic type information.
    /// </summary>
    /// <typeparam name="T">The type parameter for additional context.</typeparam>
    /// <param name="context">The proxy context.</param>
    /// <returns>A unique cache key.</returns>
