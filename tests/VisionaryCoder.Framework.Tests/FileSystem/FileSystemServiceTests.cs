...
/// <summary>
/// Comprehensive data-driven unit tests for FileSystemService to ensure 100% code coverage.
/// Tests happy path, edge cases, and expected failures using temporary file system operations.
/// </summary>
[TestClass]
public class FileSystemServiceTests
{
    private Mock<ILogger<FileSystemService>>? mockLogger;
    ...
    public void Initialize()
    {
        ...
        testDirectory = Path.Combine(Path.GetTempPath(), $"FileSystemServiceTests_{Guid.NewGuid():N}");
    ...
    public void Constructor_WithValidLogger_ShouldInitializeSuccessfully()
    {
        ...
        // Act
        var service = new FileSystemService(mockLogger.Object);
    ...
    {
        // Arrange
        var filePath = Path.Combine(testDirectory!, "nonexistent.txt");
        var fileInfo = new FileInfo(filePath);
    ...
    {
        // Arrange
        var filePath = Path.Combine(testDirectory!, relativePath);
    ...
    {
        // Arrange
        var filePath = Path.Combine(testDirectory!, "async_test.txt");
    ...
    {
        // Arrange
        var filePath = Path.Combine(testDirectory!, "cancel_test.txt");
        await File.WriteAllTextAsync(filePath, "content");
    ...
    {
        // Arrange
        var filePath = Path.Combine(testDirectory!, "bytes.bin");
    ...
    {
        // Arrange
        var filePath = Path.Combine(testDirectory!, "nonexistent.bin");
    ...
    public async Task ReadAllBytesAsync_WithValidFile_ShouldReturnBytes()
    {
        ...
        var filePath = Path.Combine(testDirectory!, "async_bytes.bin");
    ...
    {
        // Arrange
        var filePath = Path.Combine(testDirectory!, "write_test.txt");
    ...
    {
        // Arrange
        var filePath = Path.Combine(testDirectory!, "null_content.txt");
    ...
    {
        // Arrange
        var filePath = Path.Combine(testDirectory!, "async_write.txt");
    ...
    {
        // Arrange
        var filePath = Path.Combine(testDirectory!, "write_bytes.bin");
    ...
    {
        // Arrange
        var filePath = Path.Combine(testDirectory!, "null_bytes.bin");
    ...
    {
        // Arrange
        var filePath = Path.Combine(testDirectory!, "async_write_bytes.bin");
    ...
    {
        // Arrange
        var filePath = Path.Combine(testDirectory!, "delete_me.txt");
        File.WriteAllText(filePath, "content");
    ...
    {
        // Arrange
        var filePath = Path.Combine(testDirectory!, "nonexistent_delete.txt");
    ...
    {
        // Arrange
        var filePath = Path.Combine(testDirectory!, "async_delete_me.txt");
        await File.WriteAllTextAsync(filePath, "content");
    ...
    {
        // Arrange
        var dirPath = Path.Combine(testDirectory!, "existing_dir");
    ...
    {
        // Arrange
        var dirPath = Path.Combine(testDirectory!, "nonexistent_dir");
    ...
    {
        // Arrange
        var dirPath = Path.Combine(testDirectory!, "new_directory");
    ...
    {
        // Arrange
        var dirPath = Path.Combine(testDirectory!, "level1", "level2", "level3");
    ...
    {
        // Arrange
        var dirPath = Path.Combine(testDirectory!, "existing");
        Directory.CreateDirectory(dirPath);
    ...
    {
        // Arrange
        var dirPath = Path.Combine(testDirectory!, "async_new_directory");
    ...
    {
        // Arrange
        var dirPath = Path.Combine(testDirectory!, "delete_dir");
        Directory.CreateDirectory(dirPath);
    ...
    {
        // Arrange
        var dirPath = Path.Combine(testDirectory!, "delete_with_files");
        Directory.CreateDirectory(dirPath);
    ...
    {
        // Arrange
        var dirPath = Path.Combine(testDirectory!, "delete_fail");
        Directory.CreateDirectory(dirPath);
        File.WriteAllText(Path.Combine(dirPath, "file.txt"), "content");
    ...
    {
        // Arrange
        var dirPath = Path.Combine(testDirectory!, "nonexistent_delete_dir");
    ...
    {
        // Arrange
        var dirPath = Path.Combine(testDirectory!, "async_delete_dir");
        Directory.CreateDirectory(dirPath);
    ...
    {
        // Arrange
        var dirPath = Path.Combine(testDirectory!, "files_dir");
        Directory.CreateDirectory(dirPath);
    ...
    {
        // Arrange
        var dirPath = Path.Combine(testDirectory!, "empty_dir");
        Directory.CreateDirectory(dirPath);
    ...
    {
        // Arrange
        var dirPath = Path.Combine(testDirectory!, "parent_dir");
    ...
    {
        // Arrange
        var dirPath = Path.Combine(testDirectory!, "pattern_dir");
    ...
    {
        // Arrange
        var dirPath = Path.Combine(testDirectory!, "enumerate_dir");
        Directory.CreateDirectory(dirPath);
    ...
    {
        // Arrange
        var dirPath = Path.Combine(testDirectory!, "cancel_enumerate");
        Directory.CreateDirectory(dirPath);
        for (int i = 0; i < 100; i++)
        {
    ...
    {
        // Arrange
        var filePath = Path.Combine(testDirectory!, "integration_test.txt");
    ...
    {
        // Arrange
        var filePath = Path.Combine(testDirectory!, "async_integration.txt");
        var content = "Async integration test";
    ...
    {
        // Arrange
        var dirPath = Path.Combine(testDirectory!, "integration_dir");
