...
public class ExceptionTests
{
    ...
    {
        // Act
        var exception = new VisionaryCoder.Framework.Proxy.Abstractions.Exceptions.ProxyException();
    ...
    public void ProxyException_WithMessageAndInnerException_ShouldStoreBoth()
    {
        ...
        // Act
        var exception = new VisionaryCoder.Framework.Proxy.Abstractions.Exceptions.ProxyException(message, inner);
    ...
    public void RetryException_WithAllParameters_ShouldStoreAll()
    {
        ...
        // Act
        var exception = new VisionaryCoder.Framework.Proxy.Abstractions.Exceptions.RetryException(message, attemptCount, inner);
    ...
    {
        // Arrange & Act
        var retryException = new VisionaryCoder.Framework.Proxy.Abstractions.Exceptions.RetryException(1);
        ...
        // Assert
        retryException.Should().BeAssignableTo<VisionaryCoder.Framework.Proxy.Abstractions.Exceptions.ProxyException>();
    ...
    {
        // Arrange & Act
        var proxyException = new VisionaryCoder.Framework.Proxy.Abstractions.Exceptions.ProxyException();
